    ...
    <div className="w-11/12 mx-auto">
      <h1 className="text-white text-center text-3xl font-semibold my-10">
        <span className="p-1 border-b-2 border-primary">
          Add <span className="text-primary">A Product</span>
        </span>
      </h1>
        ...
        <div className="card-body">
          <form onSubmit={handleSubmit(handleSubmitForm)}>
              ...
              <div className="form-control">
                <label className="label cursor-pointer justify-evenly">
                  ...
                  <input
                    ...
                    name="category"
                    className="radio checked:bg-blue-500"
                    checked={category === "Tesla"}
                    onChange={() => setCategory("Tesla")}
                  />
                </label>
              </div>
              <div className="form-control">
                <label className="label cursor-pointer justify-evenly">
                  ...
                  <input
                    ...
                    name="category"
                    className="radio checked:bg-blue-500"
                    checked={category === "BMW"}
                    onChange={() => setCategory("BMW")}
                  />
                </label>
              </div>
              <div className="form-control">
                <label className="label cursor-pointer justify-evenly">
                  ...
                  <input
                    ...
                    name="category"
                    className="radio checked:bg-blue-500"
                    checked={category === "Toyota"}
                    onChange={() => setCategory("Toyota")}
                  />
                </label>
              </div>
            </div>
            ...
            <div className="form-control">
              ...
              />
              {errors.UsedYears && (
                <p className="text-red-600">{errors.UsedYears?.message}</p>
              )}
            </div>
            ...
            <div className="form-control">
              ...
              />
              {errors.sellerPhone && (
                <p className="text-red-600">{errors.sellerPhone?.message}</p>
              )}
            </div>
