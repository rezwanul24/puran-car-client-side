  ...
  return (
    <div className=" min-h-[85vh] flex flex-col items-center justify-center">
      <div className="w-10/12 mx-auto">
        <div
          tabIndex={0}
          className=" mt-4 collapse collapse-arrow border border-base-300 bg-base-100 rounded-box"
        >
          ...
          <div className="collapse-content">
            <div className="overflow-x-auto">
              <p>
                The different ways to manage a state in a React application is
                Redux. Redux is a library that has been around for a long time
                and is widely used in the React environment. Redux is a tool
                that comes to solve both of the problems mentioned before (prop
                drilling and unpredictable state behavior on frequent and
                complex state changes). It's important to mention that Redux is
                an agnostic library, meaning it can be implemented on any front
                end app, not just React. The Redux set of tools is very similar
                to what we've just seen with useReducer, but with a few more
                things. There are three main building blocks in Redux: A store —
                an object that holds the app state data A reducer — a function
                that returns some state data, triggered by an action type An
                action — an object that tells the reducer how to change the
                state. It must contain a type property, and it can contain an
          ...
          <div className="collapse-content">
            <div className="overflow-x-auto overflow-hidden ">
              ...
              <p>
                ...
                performs as expected. Unit Testing is done during the
        ...
        >
          ...
          <div className="collapse-content">
            ...
            <p>
              {" "}
              However, they all have a different structure and architecture — so
              first, we’ll look into their architectural differences to
